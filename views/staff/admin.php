...
if (isset($_POST['edit'])) {
    ...
    if ($userupdate) {
        echo "<h3 class='text-success'>Admin Updated successfully</h3>";
        // Refresh the user data after update
        $user = $userModel->select($_SESSION['email']);
    } else {
        echo "<h3 class='text-danger'>Admin doesn't Update successfully</h3>";
    }
}
?>
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        ...
                        <h2><?= isset($user['user_name']) ? $user['user_name'] : 'Username Not Found'; ?></h2>
                        <h3>Fryco Admin</h3>
                    </div>
                </div>
            </div>
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8"><?= $user['addresss']; ?></div>
                                </div>
                                <div class="row">
