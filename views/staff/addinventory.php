...
// If the user is an admin, include the navbar and proceed
...
if (isset($_POST['submit'])) {
    ...
    $result = $inventoryController->insert($item_name, $quantity, $supplier_id);

    if ($result) {
        echo "<h3 class='text-success'>Inventory item added successfully</h3>";
    } else {
        echo "<h3 class='text-danger'>Failed to add inventory item</h3>";
    }
}
?>
<?php if($user['rolee'] == 2): ?>
