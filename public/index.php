...
<body>
        ...
        <div id="carouselExample" class="carousel slide mt-2" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="./images/12.jpg" class="d-block w-100" alt="Image 1">
                ...
                <div class="carousel-item">
                    <img src="./images/desktop_thumbnail_27e08e66-1f58-4b6a-bafa-70caadd054ec.jpg" class="d-block w-100" alt="Image 3">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Welcome to Fryco & Grill</h5>
                        <p>Delicious fried and grilled chicken just for you!</p>
                        <a href="#" class="btn btn-outline-light">View Menu</a>
    ...
    <div class="circle-container">
        <div class="circle">
            <img src="./images/images.jpeg" class="circle-img" alt="Burger">
            <div class="overlay">Burger</div>
        </div>
        <div class="circle">
            <img src="./images/five-star.avif" class="circle-img" alt="Pizza">
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-3">
                <div class="card">
                    <img src="./images/five-star.avif" class="card-img-top" alt="Ad 1">
                    <div class="card-body">
            ...
            <div class="col-md-3">
                <div class="card">
                    <img src="./images/ai-generative-3d-style-design-of-fried-chicken-in-yellow-background-photo.jpg" class="card-img-top" alt="Ad 2">
                    <div class="card-body">
            ...
            <div class="col-md-3">
                <div class="card">
                    <img src="./images/oporto-family-burger-meal.jpg" class="card-img-top" alt="Ad 3">
                    <div class="card-body">
            ...
            <div class="col-md-3">
                <div class="card">
                    <img src="./images/fried.webp" class="card-img-top" alt="Ad 4">
                    <div class="card-body">
